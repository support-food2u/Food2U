      ...
      <section className="about-section" id="aboutUs">
        ...
        <div className="container">
          ...
          <div className="team-grid">
            ...
            <a href="https://www.linkedin.com/in/rohan-a-m-0382a2324/" target="_blank" className="team-card gsap-team"><div className="team-card__avatar av-4">R</div><div className="team-card__info"><h4>Rohan A M</h4><span>LinkedIn <i className="bi bi-arrow-up-right"></i></span></div><div className="team-card__line"></div></a>
          </div>
        </div>
      </section>
    </>
